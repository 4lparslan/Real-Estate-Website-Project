<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="property.aspx.cs" Inherits="Emlak5.property" %>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
            ...
            <li class="active"><a href="property.aspx">PROPERTIES</a></li>
              ...
              <ul class="aa-properties-nav">
                <li>
                  <article class="aa-properties-item">
                    <a class="aa-properties-item-img" href="#">
                      <img alt="img" src="img/slider/6.jpg">
                    </a>
                ...
                <li>
                 ...
                 <li>
                  <article class="aa-properties-item">
                    <a class="aa-properties-item-img" href="#">
                      <img alt="img" src="img/slider/2.jpg">
                    </a>
                    <div class="aa-tag sold-out">
                      Sold Out
                    </div>
                ...
                <li>
                  <article class="aa-properties-item">
                    <a class="aa-properties-item-img" href="#">
                      <img alt="img" src="img/slider/5.jpg">
                    </a>
                 ...
                 <li>
                  <article class="aa-properties-item">
                    <a class="aa-properties-item-img" href="#">
                      <img alt="img" src="img/slider/3.jpg">
                    </a>
                    <div class="aa-tag for-rent">
                        For Rent
                    </div>
                 ...
                 <li>
                  <article class="aa-properties-item">
                    <a class="aa-properties-item-img" href="#">
                      <img alt="img" src="img/slider/4.jpg">
                    </a>
                    <div class="aa-tag for-sale">
                      For Sale
                    </div>
